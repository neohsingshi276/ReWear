                  ...
                  <div className="relative h-48 rounded-3xl overflow-hidden group">
                     ...
                     <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent p-6 flex flex-col justify-end text-white">
                        <div className="transform transition-transform duration-500 group-hover:translate-y-[-4px]">
                           ...
                           <div className="flex items-center gap-3">
                              <span className="bg-white/20 backdrop-blur-md px-3 py-1 rounded-lg text-sm font-semibold">${selectedProduct.price}</span>
                  ...
                  <div className="md:col-span-5 flex flex-col h-full border-l border-gray-100 pl-8 relative">
                     <div className="sticky top-0 space-y-8">
                        ...
                        <div className="bg-gray-50 p-6 rounded-2xl">
                           ...
                           <p className="text-xs text-gray-500 mt-3 text-center">Add <span className="font-bold text-gray-900">${(parseFloat(selectedProduct.price) * donationPercent / 100).toFixed(2)}</span> donation</p>
                        </div>

                        <div className="space-y-4 py-6 border-t border-b border-gray-100">
                           <div className="flex justify-between text-gray-600">
                              <span>Subtotal</span>
                              <span className="font-medium">${parseFloat(selectedProduct.price).toFixed(2)}</span>
                           </div>
                           <div className="flex justify-between text-rose-500">
                              <span>Donation</span>
                              <span className="font-medium">+${(parseFloat(selectedProduct.price) * donationPercent / 100).toFixed(2)}</span>
                           </div>
                        </div>

                        <div className="flex justify-between items-end">
                           <span className="text-gray-500 font-medium">Total due</span>
                           <span className="text-3xl font-bold text-gray-900">${(parseFloat(selectedProduct.price) * (1 + donationPercent / 100)).toFixed(2)}</span>
                        </div>
              ...
              <div className="p-8 bg-white relative">
                  ...
                  <div className="space-y-6">
                     <div className="text-center">
                        ...
                        <div className="text-4xl font-bold text-gray-900">${(parseFloat(receipt.amount) + parseFloat(receipt.donation)).toFixed(2)}</div>
                     </div>
                     ...
                     <div className="space-y-3">
                        ...
                        <div className="flex justify-between text-sm text-rose-500">
                           ...
                           <span className="font-medium">${receipt.donation}</span>
                        </div>
                     </div>
                  </div>
